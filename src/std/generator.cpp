...
void benchmark()
{
    ankerl::nanobench::Bench().run("std::generator: infinite_counter", [] {
        int sum = 0;
    ...
    ankerl::nanobench::Bench().run("std::generator: finite_counter (iterator)", [] {
        auto gen = finite_counter(1000);
        int sum = 0;
    ...
    ankerl::nanobench::Bench().run("std::generator: finite_counter (range-for)", [] {
        int sum = 0;
